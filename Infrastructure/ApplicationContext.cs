...
namespace Infrastructure
{
	public class ApplicationContext : IdentityDbContext<User, Role, int>
	{
		...
		{
			optionsBuilder.UseSqlServer(@"Server=tcp:fpespms.database.windows.net,1433;Initial Catalog=fpespmsDB;Persist Security Info=False;User ID=fpespmsAdmin;Password=Believer@;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;", options =>
